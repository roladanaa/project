...
@section('title',__('dash.edit_subcategory'))
@section('title_page',__('dash.edit_subcategory'))
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name_ar" class="form-control" placeholder="{{__('dash.name_ar')}}"  value="{{$subCategory->name_ar}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name_en" class="form-control" placeholder="{{__('dash.name_en')}}"  value="{{$subCategory->name_en}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="file" id="image" class="form-control" placeholder="{{__('dash.upload_image')}}" >
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="preview-image ">
                                            <img src="{{Storage::url($subCategory->image)}}"  alt="">
                                        </div>
                                    </div>

                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <label for="city_id">{{__('dash.role')}}</label>
                                            <select class="select2 form-control select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" id="city_id">
                                                ...
                                                @foreach ($city as $c)
                                                    <option value="{{$c->id}}" @selected($c->id == $subCategory->city_id)>{{$c->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <label for="category_id">{{__('dash.role')}}</label>
                                            <select class="select2 form-control select2-hidden-accessible" data-select2-id="2" tabindex="-1" aria-hidden="true" id="category_id">
                                                ...
                                                @foreach ($category as $c)
                                                    <option value="{{$c->id}}" @selected($c->id == $subCategory->category_id)>{{$c->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
<script>
    function performUpdate(){
        ...
        performUpdateWithTostar('/sub_categories/{{$subCategory->id}}',formData);
    }
</script>
@endsection