...
@section('title',__('dash.edit_countriy'))
@section('title_page',__('dash.edit_countriy'))
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control" placeholder="{{__('dash.name_ar')}}" id="name_ar" value="{{$city->name_ar}}">
                                            <label for="first-name-column">{{__('dash.name_ar')}}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name_en" class="form-control" placeholder="{{__('dash.name_en')}}" value="{{$city->name_en}}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="active" @checked($city->active)>
...
<script>
    function performUpdate(){
        ...
        performUpdateWithTostar('/cities/{{$city->id}}',dataObj);
