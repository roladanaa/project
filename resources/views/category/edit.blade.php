...
@section('title',__('dash.edit_category'))
@section('title_page',__('dash.edit_category'))
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name_ar" class="form-control" placeholder="{{__('dash.name_ar')}}"  value="{{$category->name_ar}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="name_en" class="form-control" placeholder="{{__('dash.name_en')}}"  value="{{$category->name_ar}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="active" @checked($category->status == 'active')>
...
<script>
    function performUpdate(){
        ...
        performUpdateWithTostar('/categories/{{$category->id}}',formData);
    }
</script>
@endsection